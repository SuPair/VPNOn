...
class LTThemeManager
{
    ...
    func activateTheme(theme : LTTheme)
    {
        ...
        UINavigationBar.appearance().titleTextAttributes = NSDictionary(objects: [theme.textColor], forKeys: [NSForegroundColorAttributeName]) as [NSObject : AnyObject] as [NSObject : AnyObject]
